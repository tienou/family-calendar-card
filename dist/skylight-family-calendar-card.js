                ...
                ${this.addExpansionPanel("Calendars",W`
                        ${this.getConfigValue("calendars").map((e,t)=>W`
                                ${this.addExpansionPanel(`Calendar: ${e.name??e.entity}`,W`
                                        ...
                                        ${this.addIconPickerField("calendars."+t+".titleIcon","Title icon (Material Symbols)")}
